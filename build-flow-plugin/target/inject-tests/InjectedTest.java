...
public class InjectedTest extends junit.framework.TestCase {
  public static junit.framework.Test suite() throws Exception {
    ...
    parameters.put("basedir","/Users/araza/Desktop/new-plugins/build-flow-plugin");
    parameters.put("artifactId","build-flow-plugin");
    parameters.put("outputDirectory","/Users/araza/Desktop/new-plugins/build-flow-plugin/target/classes");
    parameters.put("testOutputDirectory","/Users/araza/Desktop/new-plugins/build-flow-plugin/target/test-classes");
